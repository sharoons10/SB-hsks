...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li tabIndex={0}>
        <details>
          <summary className={`text-${isDarkMode ? 'dark' : ''}`}>List</summary>
          <ul className={`p-2 ${isDarkMode ? 'dark' : ''}`}>
            ...
            <li>
              <a className={`text-${isDarkMode ? 'dark' : ''}`}>Deep Cleaning</a>
            </li>
            <li>
              <a className={`text-${isDarkMode ? 'dark' : 'dark'}`}>Vaccum Cleaning</a>
            </li>
          </ul>
        </details>
      </li>
      <li tabIndex={0}>
        <details>
          ...
          <ul className={`p-2 ${isDarkMode ? 'dark' : ''}`}>
            <li>
              <a className={`text-${isDarkMode ? 'text-white' : 'black'}`}>Online Service Booking</a>
            </li>
            <li>
              <a className={`text-${isDarkMode ? 'white' : 'black'}`}>Event Reservation</a>
            </li>
            <li>
              <a className={`text-${isDarkMode ? 'white' : 'black'}`}>Service Tracking</a>
            </li>
          </ul>
        </details>
      </li>
