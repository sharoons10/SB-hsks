      ...
      <footer className={`footer xl:px-24 py-10 px-4 text-base-content ${
        ...
        <aside>
          ...
          <p className="my-3 md:w-40">
            <b>"Savor the artistry where every service is a housekeeping masterpiece!"</b>
          </p>
        </aside>
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">piyusolank651@email.com</a>
          <a className="link link-hover">+91 93724 54280</a>
          <a className="link link-hover">Social media : Solanki Brothers Housekeeping Services(Justdial)</a>
        </nav>
      </footer>
        <hr />
