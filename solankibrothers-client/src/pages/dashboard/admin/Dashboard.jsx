    ...
    <div className="w-full md:w-[870px] mx-auto px-4 ">
      ...
      <div className="stats shadow flex flex-col md:flex-row">
        <div className="stat bg-emerald-200">
          ...
          <div className="stat-desc">Jan 1st - Present Date</div>
        </div>
        ...
        <div className="stat bg-indigo-400">
          ...
          <div className="stat-title">No. of Services</div>
        ...
        <div className="stat bg-purple-300">
          ...
          <div className="stat-title">Services in progress</div>
        ...
        <PieChart width={400} height={400}>
          ...
          >
            {pieChartData.map((entry, index) => (
              <Cell key={`cell-${index}`} fill={COLORS[index % COLO$length]} />
            ))}
          </Pie>
          <Legend/>
        </PieChart>
