...
const categoryItems = [
    {id: 1, title: "Cleaning Services", despriction: "(4 services)", image: "/images/home/category/img1.png"},
    {id: 2, title: "Maintainence", despriction: "(2 services)", image: "/images/home/category/img2.png"},
    {id: 3, title: "Sanitization", despriction: "(2 Services)", image: "/images/home/category/img3.png"},
    {id: 4, title: "Browse All", despriction: "(8 Services)", image: "/images/home/category/img4.png"}
]
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto xl:px-24 px-4 py-16 ${isDarkMode ? 'dark' : ''}`}>
        <div className='text-center'>
            <p className='subtitle'>Client Favorites</p>
