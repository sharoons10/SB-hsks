        ...
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <blockquote className="my-5 text-secondary leading-[30px]">
              “I had the pleasure of getting my house cleaned by Solanki Brothers housekeeping services and I'm absolutely satisfied by the quality of service and the value for money they provide”
            </blockquote>
